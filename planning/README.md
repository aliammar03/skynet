...
- **Trust tiers.** If a directive touches **T2+/T3** or moves a blast-radius boundary, its plan must
  also PR `docs/deployment-plan.md` — same rule as everywhere else. (`tier_touched` frontmatter flags it.)
...
|---|---|---|---|---|---|
| SKY-001 | Retire the deployment plan; stand up the system-design constitution + spokes | projects | in-progress | 1/4 | 🔭 long |
