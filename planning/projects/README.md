...
2. **Each phase closes out** — a PR, raw journal evidence, a frontmatter bump, and one Continue
   prompt in the directive for whoever picks it up next (maybe you tomorrow, maybe a different engine).
