...
# SKY-022 · Eliminate documentation drift and shrink operational context
...
- **Sibling boundaries:** SKY-012 owns executable-capability conversion; SKY-016 owns deploy feature
  improvements; SKY-020 owns firewall-as-code implementation. SKY-022 fixes their documentation
...
```
Promote SKY-022 with bin/plan start SKY-022, then read the resulting
planning/projects/SKY-022-eliminate-documentation-drift-and-shrink-operational-context.md in full.
...
- Update `[[SKY-022-progress]]`, phase checkbox/frontmatter, and run `bin/plan list`.
- Continue with: `Continue SKY-022 at Phase <N+1>; read [[SKY-022-progress]], verify reality, and execute only that phase.`
