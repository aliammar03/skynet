...
- **P5 accepted**: fresh review of PR #253 accepted the repaired workflow against the post-P7 `main`;
  every final review verdict is durable, newest applicable verdict wins, and accepted closeout remains
  bounded to bookkeeping on the same PR.
...
SKY-026 is complete. Merge accepted PR #253 once this closeout's final CI/base recheck passes, then resume
SKY-025 at P8 using the repository's existing P7→P8 transition rules.
