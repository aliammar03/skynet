...
- **P5 accepted and closed out on PR #253**: end-to-end dogfood, continuity pruning, complete SKY-022
  authority removal, and the one-PR/one-merge review/closeout lifecycle passed fresh external review.
  The reviewer posted the acceptance marker; bounded closeout was then performed on the same PR.
...
SKY-026 is accepted and archived in this closeout. Human-merge PR #253 once. After it lands on `main`,
run the one-time SKY-025 P7 integrated-main review; P7 ACCEPT releases P8.
