...
date: 2026-08-25
kind: session
title: nightly 2026-08-25 (deterministic)
tier_touched: [T1]
grants: []
refs: [runbooks/nightly.md, "inventory/2026-08-25"]
---

# 2026-08-25 · session · nightly (deterministic path)
...
```
 ...
 inventory/proxmox-core.json                       | 368 +++++++++++----------
 inventory/proxmox-network.json                    | 376 +++++++++++-----------
 14 files changed, 540 insertions(+), 474 deletions(-)
```
