...
kind: session
title: "NixOS as a declarative host-definition layer for Skynet"
tier_touched: []
grants: []
refs: [SKY-007]
thread_status: none
...
> Moved verbatim from `planning/scratchpad/research/2026-08-17-nixos-fleet.md` by the SKY-025
