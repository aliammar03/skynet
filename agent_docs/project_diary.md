...
- SKY-025 uses one open authored PR per numbered phase from P8 onward. Internal lettered slices are
  ...
  sole legacy already-merged exception. Any corrective P7 PR created after a legacy FIX uses the normal
  open-PR review mode as P8+ and never returns to the integrated-main legacy mode.
