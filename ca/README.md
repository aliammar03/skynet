...
| `skynet_ops_svc.pub` | The agent's own SSH public key — installed into the standing `svc-ops` user's `authorized_keys` for scoped T2 access. | `0600` on skynet-ops (`~/.ssh/id_ed25519`). |
