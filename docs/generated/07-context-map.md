...
**Cold-boot read:** `docs/generated/06-agent-digest.md` ≈ 1579 tok.
...
| `docs/generated/06-agent-digest.md` | 1579 | Agent Digest |
...
- `journal/` — 91 raw episodes, ≈ 103199 tok total. Retrieve by topic: `bin/recall <topic>` or `grep -ri "<topic>" journal/`; recent episodes are already in `06-agent-digest.md`. **Do not load the whole store.**

---
**On-demand corpus:** ≈ **50716** tok across 53 files — but you load a *row* (≈ tens of tok) to choose, then one file.
