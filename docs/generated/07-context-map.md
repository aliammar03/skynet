...
- `journal/` — 103 raw episodes, ≈ 119760 tok total. Retrieve by topic: `bin/recall <topic>` or `grep -ri "<topic>" journal/`; recent episodes are already in `06-agent-digest.md`. **Do not load the whole store.**

---
**On-demand corpus:** ≈ **51264** tok across 53 files — but you load a *row* (≈ tens of tok) to choose, then one file.
