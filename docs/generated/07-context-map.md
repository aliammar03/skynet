...
**Cold-boot read:** `docs/generated/06-agent-digest.md` ≈ 1114 tok.
...
| `docs/generated/06-agent-digest.md` | 1114 | Agent Digest |
...
- `journal/` — 65 raw episodes, ≈ 74818 tok total. Retrieve by topic: `bin/recall <topic>` (SKY-010 P4) or `grep -ri "<topic>" journal/`; recent episodes are already in `06-agent-digest.md`. **Do not load the whole store.**

---
**On-demand corpus:** ≈ **56355** tok across 53 files — but you load a *row* (≈ tens of tok) to choose, then one file.
