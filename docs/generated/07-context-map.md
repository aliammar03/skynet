...
**Cold-boot read:** `docs/generated/06-agent-digest.md` ≈ 1656 tok.
...
| `docs/generated/06-agent-digest.md` | 1656 | Agent Digest |
...
- `journal/` — 97 raw episodes, ≈ 111290 tok total. Retrieve by topic: `bin/recall <topic>` or `grep -ri "<topic>" journal/`; recent episodes are already in `06-agent-digest.md`. **Do not load the whole store.**

---
**On-demand corpus:** ≈ **51176** tok across 53 files — but you load a *row* (≈ tens of tok) to choose, then one file.
