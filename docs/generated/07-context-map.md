...
- `journal/` — 106 raw episodes, ≈ 121981 tok total. Retrieve by topic: `bin/recall <topic>` or `grep -ri "<topic>" journal/`; recent episodes are already in `06-agent-digest.md`. **Do not load the whole store.**

---
**On-demand corpus:** ≈ **51274** tok across 53 files — but you load a *row* (≈ tens of tok) to choose, then one file.
