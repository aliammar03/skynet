...
# `scripts/tofu-apply.sh <planfile>`). This script is the BREAK-GLASS / immediate path (and `--delete`
# for an urgent pull); reconcile through the saved-plan path afterward so state matches.
# USAGE:
